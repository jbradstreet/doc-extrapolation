...
(function () {
  var MainController = function () {
    function MainController($http) {
      ...
      this.$http = $http;
      this.awesomeThings = [];
      this.myPattern = "../../assets/images/ideawoman-f02e26a9e6.jpg";
    }
...
angular.module("docExtrapolationApp").run(["$templateCache", function($templateCache) {$templateCache.put("components/footer/footer.html","<div class=\"container\">\n  <p>Lovingly Made by Jenni Bradstreet |\n    <a href=\"https://github.com/jbradstreet/doc-extrapolation\">GitHub</a> \n  </p>\n</div>\n");
